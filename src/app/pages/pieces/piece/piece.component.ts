...
export class PieceComponent {
  ajoutPrestation: boolean = false;
  editPrestation: boolean = false;
  ...
  ovrirEditPrestation() {
    this.submitted = false;
    this.editPrestation = true;
  }

  hideEditPrestation() {
    this.editPrestation = false;
    this.submitted = false;
  }
...
onRowClick(product: any) {
  ...
  alert(`Produit cliqué : ${product.name} (ID: ${product.id})`);
}
}
